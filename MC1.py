...
def distance_carrer(centre, position, rayon_echantillonne, dossier):
    i = 0
    hauteur = 100 #cm petit réacteur
...
parser.add_argument('m', help='ex 1')
parser.add_argument('l', help='ex 10')
parser.add_argument('dossier', help='ex toto')
args = parser.parse_args()

start(int(args.m),int(args.n),coeur(int(args.l)),str(args.dossier))